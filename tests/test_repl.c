...
int main(void){test_repl();test_repl_null_presentation();test_incomplete();test_conversions();if(failures==0){puts("Todos os testes do REPL passaram.");return 0;}return 1;}
