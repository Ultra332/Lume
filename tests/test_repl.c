...
int main(void){test_repl();test_repl_null_presentation();test_incomplete();test_conversions();test_recursion_error_recovery_and_source();test_old_source_diagnostics();if(failures==0){puts("Todos os testes do REPL passaram.");return 0;}return 1;}
