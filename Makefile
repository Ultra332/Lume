...
TARGET ?= lume
TEST_TARGETS := test_lexer test_expression test_program test_control_flow test_functions test_cli test_repl test_diagnostics test_lists test_education test_analyzer test_modules test_project test_dependencies test_stdlib
