...
O script limpa o build, compila, executa as 17 suítes, gera metadata do
...
```text
dist/
├── Lume-0.2.1-Windows-x64-Setup.exe
├── Lume-0.2.1-Windows-x64.zip
└── SHA256SUMS.txt
```
...
- anexar `Lume-0.2.1-Windows-x64-Setup.exe`;
- anexar `Lume-0.2.1-Windows-x64.zip`;
